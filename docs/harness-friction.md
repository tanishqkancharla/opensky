...
Postmerge Calc smoke: PR8 merged at 53b2a81deaa7119a31a0e68bbfc0962e1652bf90; its complete tree is byte-equivalent to certified ed9. Canonical Linux 129/129 plus 15 intended SDK controls and installer passed before merge. This wrapper now verifies actual merged local installation, identity/configuration, daemon startup and owned cleanup. The fork auto-release job fails at missing GitHub App ID; no public release is claimed.


### PR9 merged-source installer verification (2026-09-11)

Pin the isolated Linux source-install smoke to merged driver `3a8b719e728914adaa27e22852948a4197274e39`. Its full Git tree equals candidate `040d0cacfcaf32e6051b372e2e1e38c2e9c4a22f`, certified by 129 canonical Linux cases and an exact-certified-binary public SDK popup replay. This smoke checks installation, exact source identity, daemon startup/status, and cleanup; it does not certify GUI behavior or a published release.
