# Historical Linux parity planning notes

Archived on 2026-09-11. Every status, pending item, spending amount and instruction
below is historical; it does not authorize work or describe current liveness.
Use [the current plan](linux-parity-plan.md) and actual run artifacts instead.
